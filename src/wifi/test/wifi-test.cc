...
{
  if ((p->GetSize () == 123456) && (Simulator::Now () > Seconds (20)))
    {
      m_received++;
    }
}
...
Bug730TestCase::DoRun (void)
{
  ...
  client->SetAttribute ("PacketSize", UintegerValue (123456));
...
Bug2222TestCase::DoRun (void)
{
  ...
  clientLowPriority->SetAttribute ("PacketSize", UintegerValue (123456));
  ...
  clientHighPriority->SetAttribute ("PacketSize", UintegerValue (123456));
